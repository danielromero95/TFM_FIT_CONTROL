"""Estimadores de pose basados en los grafos ``Pose`` de Mediapipe."""
...
class PoseEstimator(PoseEstimatorBase):
    """Ejecuta Mediapipe en frames completos sin recortes adicionales."""
    ...
    def __init__(
        ...
        """Configura el grafo principal y las referencias a utilidades de dibujo."""
    ...
    def _ensure_pose(self) -> None:
        """Obtiene una instancia ``Pose`` del *pool* si aún no existe."""
    ...
    def estimate(self, image_bgr: np.ndarray) -> PoseResult:
        """Evalúa ``image_bgr`` y devuelve los landmarks y la imagen anotada."""
    ...
    def close(self) -> None:
        """Libera la instancia de Mediapipe que se estuviese reutilizando."""
...
class CroppedPoseEstimator(PoseEstimatorBase):
    """Combina una pasada completa con una pasada recortada para afinar la pose."""
    ...
    def __init__(
        ...
        """Inicializa los grafos de Mediapipe y los parámetros de recorte."""
    ...
    def _ensure_graphs(self) -> None:
        """Garantiza que existen grafos completos y recortados listos para usar."""
    ...
    def estimate(self, image_bgr: np.ndarray) -> PoseResult:
        """Detecta la pose recortando alrededor del sujeto y refinando la imagen."""
    ...
    def close(self) -> None:
        """Devuelve los grafos usados al *pool* y limpia el estado temporal."""
...
class RoiPoseEstimator(PoseEstimatorBase):
    """Mantiene una ROI dinámica para acelerar las inferencias sucesivas."""
    ...
    def __init__(
        ...
        """Prepara los grafos y los parámetros de seguimiento de la ROI."""
    ...
    def _ensure_graphs(self) -> None:
        """Asegura que los grafos global y recortado están disponibles."""
    ...
    def estimate(self, image_bgr: np.ndarray) -> PoseResult:
        """Evalúa ``image_bgr`` reaprovechando la última ROI válida cuando sea posible."""
    ...
    def close(self) -> None:
        """Entrega los grafos al *pool* y reinicia el seguimiento interno."""
