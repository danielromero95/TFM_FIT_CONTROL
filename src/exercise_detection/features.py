...
def build_features_from_landmark_array(landmarks_arr: "np.ndarray") -> Dict[str, float]:
...
def build_features_from_landmarks(landmarks: list[dict[str, float]]) -> Dict[str, float]:
...
def _features_from_coords(coords: "np.ndarray") -> Dict[str, float]:
    """Calcular características usando un array (33,3) con NaN en coordenadas inválidas."""
