...
SQUAT_KNEE_DEEP_THRESHOLD_DEG = 125.0
SQUAT_DEEP_FRACTION_MIN = 0.25
...
SQUAT_BAR_HIGH_FRACTION_MIN = 0.35
SQUAT_ELBOW_FLEXED_FRACTION_MIN = 0.30
...
DEADLIFT_SQUAT_ROM_THRESHOLD_DEG = 45.0
DEADLIFT_HIP_KNEE_RATIO_MIN = 0.7
DEADLIFT_FRONT_TORSO_WEIGHT_FACTOR = 0.55
DEADLIFT_KNEE_DEEP_VETO_FRACTION = 0.22
DEADLIFT_BAR_LOW_FRACTION_MIN = 0.45
DEADLIFT_ELBOW_EXTENDED_FRACTION_MIN = 0.45
DEADLIFT_FRONT_ARM_WEIGHT = 0.65
DEADLIFT_FRONT_BAR_BONUS_WEIGHT = 0.5

DEADLIFT_VETO_SCORE_CLAMP = 0.8
DEADLIFT_FRONT_VETO_SCORE_CLAMP = 0.2
