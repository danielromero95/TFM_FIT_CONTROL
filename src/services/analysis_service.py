...
def run_pipeline(
    ...
    *,
    ...
    # ``rotate`` used to be the canonical variable name in this scope. Maintain an
    # alias so legacy helper paths (and user overrides relying on it) keep
    # working even after the refactor to ``processing_rotate``.
