...
def test_prepare_pipeline_inputs_propagates_threshold_enable_false(tmp_path) -> None:
...
def test_prepare_pipeline_inputs_defaults_threshold_enable_true(tmp_path) -> None:
    video_path = tmp_path / "video.mp4"
    video_path.write_bytes(b"content")
